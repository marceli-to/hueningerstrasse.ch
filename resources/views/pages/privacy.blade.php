  ...
  <section class="bg-white">
    <x-layout.inner class="py-40 md:py-56 lg:py-64">
      <div class="max-w-2xl" data-reveal>
        <x-headings.h1>Datenschutzerklärung</x-headings.h1>
        ...
        <x-headings.h3 class="mt-24 mb-8">Cookies</x-headings.h3>
        <p>
        ...
        <p>
          ...
          ausschliessen sowie das automatische Löschen der Cookies beim Schliessen des Browser aktivieren. Bei der
          Deaktivierung von Cookies kann die Funktionalität dieser Website eingeschränkt sein.
        </p>

        <x-headings.h3 class="mt-24 mb-8">Hosting Provider &amp; Server-LogFiles</x-headings.h3>
        <p>
          Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log Files,
          die Ihr Browser automatisch an uns übermittelt. Dies sind:
        </p>
        <ul class="list-disc pl-20 my-8 space-y-2">
          <li>IP-Adresse</li>
        ...
        <p>
          Diese Daten können nicht direkt bestimmten Personen zugeordnet werden. Eine Zusammenführung dieser Daten
        ...
        <p>
          Diese Daten sowie alle Daten dieser Website werden bei unserem Hosting-Provider webkeeper GmbH, 8604
          Volketswil, Schweiz gespeichert, deren Datenschutzerklärung Sie
          <a href="https://www.webkeeper.ch/de/unternehmen/datenschutz" target="_blank" rel="noopener noreferrer" class="text-bordeaux hover:text-ink transition-colors">hier</a>
          finden.
        </p>
        ...
        <p>
          ...
          Kontaktaufnahme genutzt werden kann. Nehmen Sie diese Möglichkeit wahr, so werden die in der Eingabemaske
        ...
        <p class="font-bold mt-16">Dauer der Speicherung und Widerspruchsrecht</p>
        <p>
          Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zur Verarbeitung der personenbezogenen Daten per
          E-Mail an
          <a href="mailto:info@apleona.com" class="text-bordeaux hover:text-ink transition-colors">info@apleona.com</a>
        ...
        <x-headings.h3 class="mt-24 mb-8">Google Analytics</x-headings.h3>
        <p>
        ...
        <p class="font-bold mt-16">IP Anonymisierung</p>
        <p>
        ...
        <p class="font-bold mt-16">Browser Plugin</p>
        <p>
          ...
          Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie das unter dem diesem
          <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer" class="text-bordeaux hover:text-ink transition-colors">Link</a>
          verfügbare Browser-Plugin herunterladen und installieren.
        </p>
        <p>
          Mehr Informationen zum Umgang mit Nutzerdaten bei Google Analytics finden Sie in der
          <a href="https://support.google.com/analytics/answer/6004245?hl=de" target="_blank" rel="noopener noreferrer" class="text-bordeaux hover:text-ink transition-colors">Datenschutzerklärung von Google</a>.
        </p>
        <p class="font-bold mt-16">Auftragsdatenverarbeitung</p>
        <p>
        ...
        <p class="font-bold mt-16">Demografische Merkmale bei Google Analytics</p>
        <p>
          ...
          die Anzeigeneinstellungen in Ihrem GoogleKonto deaktivieren oder die Erfassung Ihrer Daten durch Google
          Analytics wie im Punkt "Widerspruch gegen Datenerfassung" dargestellt generell untersagen.
        </p>

        <x-headings.h3 class="mt-24 mb-8">Google Maps</x-headings.h3>
        <p class="font-bold">Umfang, Zweck und Rechtsgrundlage der Datenverarbeitung</p>
        <p>
          Diese Webseite verwendet Google Maps zur Nutzung von Karten und zur Erstellung von Anfahrtsplänen. Es
          handelt sich hierbei um einen Dienst der Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043
          USA, nachfolgend nur „Google" genannt. Durch die Zertifizierung nach dem EU-US-Datenschutzschild
          („EU-US Privacy Shield") garantiert Google, dass die Datenschutzvorgaben der EU auch bei der Verarbeitung
          von Daten in den USA eingehalten werden.
        </p>
        <p>
          Sofern Sie auf dieser Webseite Google Maps aufrufen, speichert Google über Ihren Internet-Browser ein
          Cookie auf Ihrem Endgerät. Um den Standort anzuzeigen, werden Ihre Nutzereinstellungen und -daten
          verarbeitet. Hierbei kann nicht ausgeschlossen werden, dass Google Server in den USA einsetzt. Die
          Verarbeitung beruht auf dem berechtigten Interesse des Webseitenbetreibers. Das berechtigte Interesse
          liegt in der Optimierung der Funktionalität des Internetauftritts.
        </p>
        <p class="font-bold mt-16">Dauer der Speicherung und Widerspruchsrecht</p>
        <p>
        ...
        <p>
          ...
          <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer" class="text-bordeaux hover:text-ink transition-colors">Google-Nutzungsbedingungen</a>
          und den
          <a href="https://www.google.com/intl/de_de/help/terms_maps.html" target="_blank" rel="noopener noreferrer" class="text-bordeaux hover:text-ink transition-colors">Geschäftsbedingungen für Google Maps</a>.
        </p>

        <x-headings.h3 class="mt-24 mb-8">Recht auf Auskunft, Löschung, Sperrung</x-headings.h3>
        <p>
          ...
          können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden oder eine E-Mail an
          <a href="mailto:info@apleona.com" class="text-bordeaux hover:text-ink transition-colors">info@apleona.com</a>
          senden.
        </p>

        <x-headings.h3 class="mt-24 mb-8">Verwendung von Adobe Fonts</x-headings.h3>
        <p>
          Wir verwenden auf dieser Webseite die Schriftarten von Adobe Fonts, um ein ansprechendes Design und eine
          bessere Lesbarkeit zu gewährleisten. Adobe Fonts ist ein Dienst der Adobe Systems Software Ireland
          Limited, 4-6 Riverwalk, Citywest Business Campus, Dublin 24, Irland.
        </p>
        <p>
          Beim Besuch dieser Webseite werden die Schriften von Adobe von Ihrem Browser geladen, um die Schrift
          korrekt darzustellen. Zu diesen Informationen können auch personenbezogene Daten gehören, insbesondere:
        </p>
        <ul class="list-disc pl-20 my-8 space-y-2">
        ...
        <p>
          Die Verarbeitung Ihrer personenbezogenen Daten im Zusammenhang mit Adobe Fonts erfolgt zum Zweck der
          Darstellung der Schriftarten auf dieser Webseite und zur Gewährleistung einer einheitlichen und
          ansprechenden visuellen Gestaltung. Die Rechtsgrundlage für die Datenverarbeitung ist Art. 6 Abs. 1 lit.
          f DSGVO, da wir ein berechtigtes Interesse an der visuellen Gestaltung und Benutzerfreundlichkeit unserer
          Webseite haben.
        </p>
        <p>
          Weitere Informationen zur Datenverarbeitung durch Adobe Fonts finden Sie in der
          <a href="https://www.adobe.com/de/privacy/policies/adobe-fonts.html" target="_blank" rel="noopener noreferrer" class="text-bordeaux hover:text-ink transition-colors">Datenschutzerklärung von Adobe Fonts</a>.
        </p>
      </div>
    </x-layout.inner>
  </section>
